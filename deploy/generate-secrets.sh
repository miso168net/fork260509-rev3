...
#   - grafana_admin_password(018 obs U1 加;僅經 grafana GF_SECURITY_ADMIN_PASSWORD=$__file{...} 檔注入、
...
# grafana_admin_password(018 obs U1):僅經 GF_SECURITY_ADMIN_PASSWORD=$__file{...} 檔注入、非 URL→base64 安全。
