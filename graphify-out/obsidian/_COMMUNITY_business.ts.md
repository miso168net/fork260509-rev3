...
- [[common.ts (2)]] - code - base-web/src/utils/common.ts
...
```dataview
TABLE source_file, type FROM #community/businessts
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_app.ts]]
- 2 edges to [[_COMMUNITY_loading.ts]]
- 1 edge to [[_COMMUNITY_Router Guard Flow]]
- 1 edge to [[_COMMUNITY_Theme Token Engine]]

## Top bridge nodes
- [[common.ts (2)]] - degree 9, connects to 4 communities
