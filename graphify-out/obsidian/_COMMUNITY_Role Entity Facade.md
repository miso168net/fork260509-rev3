...
- [[ilike()_1]] - code - rust-api/server/src/model/facade/sys_role.rs
- [[list()_2]] - code - rust-api/server/src/model/facade/sys_role.rs
...
```dataview
TABLE source_file, type FROM #community/Role_Entity_Facade
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_mutate_in_txn]]
- 1 edge to [[_COMMUNITY_role_delete_guard]]
