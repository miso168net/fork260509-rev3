...
# [v1.3.10](https: github.com honghuangdc soybean-admin compare
...
```dataview
TABLE source_file, type FROM #community/v1310https_githubcom_honghuangdc_soybean-admin_compare
SORT file.name ASC
```
