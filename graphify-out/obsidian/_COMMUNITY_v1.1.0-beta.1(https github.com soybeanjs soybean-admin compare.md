...
# [v1.1.0-beta.1](https: github.com soybeanjs soybean-admin compare
...
```dataview
TABLE source_file, type FROM #community/v110-beta1https_githubcom_soybeanjs_soybean-admin_compare
SORT file.name ASC
```
