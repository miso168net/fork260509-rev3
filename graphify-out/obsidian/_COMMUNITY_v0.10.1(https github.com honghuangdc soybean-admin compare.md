...
# [v0.10.1](https: github.com honghuangdc soybean-admin compare
...
```dataview
TABLE source_file, type FROM #community/v0101https_githubcom_honghuangdc_soybean-admin_compare
SORT file.name ASC
```
