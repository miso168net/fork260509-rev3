...
```dataview
TABLE source_file, type FROM #community/System_Manage_Handlers
SORT file.name ASC
```

## Connections to other communities
- 27 edges to [[_COMMUNITY_Audit Log Handlers]]
- 10 edges to [[_COMMUNITY_reload_and_publish]]
- 8 edges to [[_COMMUNITY_user_write_from_req]]
- 6 edges to [[_COMMUNITY_records_to_csv]]
- 6 edges to [[_COMMUNITY_menu_write_from_req]]
- 3 edges to [[_COMMUNITY_role_delete_guard]]
- 3 edges to [[_COMMUNITY_role_write_from_req]]

## Top bridge nodes
- [[system_manage.rs]] - degree 157, connects to 7 communities