...
```dataview
TABLE source_file, type FROM #community/add_ip_rule
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_system_manage.rs]]
- 4 edges to [[_COMMUNITY_ok()]]

## Top bridge nodes
- [[add_ip_rule()]] - degree 5, connects to 2 communities
- [[update_ip_rule()]] - degree 5, connects to 2 communities
- [[restore_ip_rule()]] - degree 4, connects to 2 communities
- [[delete_ip_rule()]] - degree 3, connects to 2 communities
