...
- 13 edges to [[_COMMUNITY_Menu Tree Facade]]
- 8 edges to [[_COMMUNITY_menu_recycle_unified_list_and_restore_orphan]]
- 7 edges to [[_COMMUNITY_now]]
- 5 edges to [[_COMMUNITY_Role Entity Facade]]
- 2 edges to [[_COMMUNITY_Casbin Rule & RBAC Gating]]
- 1 edge to [[_COMMUNITY_audit]]
- 1 edge to [[_COMMUNITY_sys_casbin_policy_archive]]
- 1 edge to [[_COMMUNITY_system_settings]]
