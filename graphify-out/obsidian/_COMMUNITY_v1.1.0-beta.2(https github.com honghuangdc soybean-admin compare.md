...
# [v1.1.0-beta.2](https: github.com honghuangdc soybean-admin compare
...
```dataview
TABLE source_file, type FROM #community/v110-beta2https_githubcom_honghuangdc_soybean-admin_compare
SORT file.name ASC
```
