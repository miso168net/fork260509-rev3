...
# [v2.0.0-beta.2](https: github.com soybeanjs soybean-admin compare
...
```dataview
TABLE source_file, type FROM #community/v200-beta2https_githubcom_soybeanjs_soybean-admin_compare
SORT file.name ASC
```
