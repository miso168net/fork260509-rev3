...
- [[in_set()]] - `calls` [EXTRACTED]
- [[is_cdn()]] - `calls` [EXTRACTED]
- [[is_internal()]] - `calls` [EXTRACTED]
- [[is_my_public()]] - `calls` [EXTRACTED]
- [[is_trusted()]] - `calls` [EXTRACTED]
- [[normalize_xff_tokens()]] - `calls` [EXTRACTED]
- [[resolve_all_trusted_falls_back_to_peer()]] - `calls` [EXTRACTED]
- [[resolve_cdn_anchored()]] - `calls` [EXTRACTED]
- [[resolve_dual_role_soft()]] - `calls` [EXTRACTED]
- [[resolve_empty_trusted_returns_peer_direct()]] - `calls` [EXTRACTED]
- [[resolve_ipv6()]] - `calls` [EXTRACTED]
- [[resolve_multi_hop_skips_all_trusted()]] - `calls` [EXTRACTED]
- [[resolve_rightmost_untrusted_skips_trusted()]] - `calls` [EXTRACTED]
- [[resolve_skips_malformed_token()]] - `calls` [EXTRACTED]
