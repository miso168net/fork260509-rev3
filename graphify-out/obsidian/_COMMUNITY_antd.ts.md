...
```dataview
TABLE source_file, type FROM #community/antdts
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Color Palette System]]
- 6 edges to [[_COMMUNITY_colord.ts]]

## Top bridge nodes
- [[antd.ts]] - degree 14, connects to 2 communities
- [[isValidColor()]] - degree 5, connects to 2 communities
- [[getAntDPaletteColorByIndex()]] - degree 7, connects to 1 community
- [[getHsv()]] - degree 3, connects to 1 community
- [[ColorIndex]] - degree 2, connects to 1 community