...
- [[diff_endpoints()]] - `contains` [EXTRACTED]
- [[diff_protected_revoke_is_blocked()]] - `contains` [EXTRACTED]
- [[diff_pure_grant_from_empty_current()]] - `contains` [EXTRACTED]
- [[endpoint_archive_count()]] - `contains` [EXTRACTED]
- [[endpoint_loop_db_first_double_key_enforce_lockout_gateway_restore()]] - `contains` [EXTRACTED]
- [[endpoint_row_of()]] - `contains` [EXTRACTED]
...
- [[restore_menu_rows()_1]] - `contains` [EXTRACTED]
- [[restore_rows()]] - `contains` [EXTRACTED]
- [[role_id_of()_1]] - `contains` [EXTRACTED]
- [[role_id_of_in()]] - `contains` [EXTRACTED]
- [[role_menu_loop_db_first_read_write_protected_reject_atomic_audit()]] - `contains` [EXTRACTED]
- [[run_body()_1]] - `contains` [EXTRACTED]
- [[run_loop_body()]] - `contains` [EXTRACTED]
