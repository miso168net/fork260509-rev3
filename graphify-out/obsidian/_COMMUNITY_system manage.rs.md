...
- 28 edges to [[_COMMUNITY_get access log()]]
- 13 edges to [[_COMMUNITY_reload and publish()]]
- 10 edges to [[_COMMUNITY_normalize enum filter()]]
- 8 edges to [[_COMMUNITY_user write from req()]]
- 8 edges to [[_COMMUNITY_reload and publish ipgate()]]
- 6 edges to [[_COMMUNITY_records to csv()]]
- 1 edge to [[_COMMUNITY_auth.rs]]

## Top bridge nodes
- [[system_manage.rs]] - degree 179, connects to 7 communities