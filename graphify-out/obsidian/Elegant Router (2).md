...
## Connections
- [[Custom Route]] - `references` [EXTRACTED]
...
- [[Parameter Route]] - `references` [EXTRACTED]
- [[Route Caching]] - `references` [EXTRACTED]
- [[Route Structure]] - `references` [INFERRED]
- [[RouteKey (3)]] - `references` [EXTRACTED]
- [[SoybeanAdmin (3)]] - `conceptually_related_to` [INFERRED]
