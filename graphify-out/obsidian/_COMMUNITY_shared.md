...
```dataview
TABLE source_file, type FROM #community/shared
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_UI Materials Package]]
- 2 edges to [[_COMMUNITY_Color Utilities Package]]
- 2 edges to [[_COMMUNITY_shared]]
- 1 edge to [[_COMMUNITY_recommend]]

## Top bridge nodes
- [[shared.ts_2]] - degree 8, connects to 2 communities
- [[addColorAlpha()]] - degree 6, connects to 2 communities
- [[transformColorWithOpacity()]] - degree 4, connects to 1 community
- [[PageTabCssVars]] - degree 2, connects to 1 community
- [[PageTabCssVarsProps]] - degree 2, connects to 1 community